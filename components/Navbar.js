  ...
  return (
    ...
    >
      <nav className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
        ...
        <Link
          href="/"
          className="inline-flex items-center min-h-[44px] -ml-1 px-1 text-base font-bold tracking-tight text-neon-cyan hover:text-white transition-colors duration-200 font-code"
        >
        ...
        <div className="hidden lg:flex items-center gap-1 text-sm font-medium">
          ...
          {/* Résumé CTA. An internal route since Phase 18, so it navigates in
              place rather than opening a tab onto a static file. */}
          <Link
        ...
        <button
          ...
          className="lg:hidden -mr-2 flex items-center justify-center min-w-[44px] min-h-[44px] text-slate-300 hover:text-neon-cyan transition-colors"
            ...
            <div className="px-4 py-3 space-y-1">
              {links.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`flex items-center min-h-[44px] px-4 py-2.5 rounded-lg transition-colors text-sm font-medium ${
                    pathname === link.href
              ...
              <div className="pt-2 flex gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 min-h-[44px] px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-slate-300 hover:text-neon-cyan text-sm transition-colors"
                >
                ...
                <Link
                  href={profile.resumeUrl}
                  className="flex-1 flex items-center justify-center gap-2 min-h-[44px] px-4 py-2.5 bg-neon-cyan text-midnight font-semibold rounded-lg text-sm"
                >
