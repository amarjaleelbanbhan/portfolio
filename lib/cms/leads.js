...
export const PIPELINE = [
  ...
  { id: 'reviewing', label: 'Reviewing', tone: '#8b5cf6' },
  ...
  { id: 'lost', label: 'Lost', tone: '#64748b' },
  { id: 'closed', label: 'Closed', tone: '#64748b' },
...
export const PRIORITIES = [
  ...
  { id: 'low', label: 'Low', tone: '#64748b' },
];

export const pipelineTone = (status) => PIPELINE.find((s) => s.id === status)?.tone ?? '#64748b';
